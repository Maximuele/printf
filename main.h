...
int print_unsigned(va_list aa, params_t *params);
int print_address(va_list aa, params_t *params);
...
int print_hex(va_list aa, params_t *params);
int print_HEX(va_list aa, params_t *params);
int print_binary(va_list aa, params_t *params);
int print_octal(va_list aa, params_t *params);
